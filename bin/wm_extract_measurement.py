...
parser.add_argument(
    'inputDirectory',
    help='Directory of fiber clustering result obtained by <wm_cluster_from_altas.py> of multiple subjects.')
parser.add_argument(
    'outputDirectory',
...
print "=====3D SlicerModule FiberTractMeasurements====\n", module_FTSM
print "=========================="
...
subject_list = []
for dir in sub_dirs:
    # Assume the results ends with '_reg' generated by <wm_cluster_from_altas.py>
