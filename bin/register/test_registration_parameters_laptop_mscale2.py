...
#outdir = '/Users/lauren/Dropbox/Coding/OUTPUTS/MICCAI2012/test_reg_feb_4_mscale_2'
# test with smaller step size for scaling. Also non-trimmed mean.
outdir = '/Users/lauren/Dropbox/Coding/OUTPUTS/MICCAI2012/test_reg_feb_6'
#outdir = '.'
...
range_number_of_fibers = [150, 200]
range_points_per_fiber = [5, 21]
#range_sigma = [10, 20, 30]
number_of_fibers_per_step=[25, 25, 50]
