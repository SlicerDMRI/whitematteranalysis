...
fname_1T = '/Users/odonnell/Dropbox/Coding/OUTPUTS/MICCAI2012/compare_1T_2T/01030-dwi-filt-Ed-DTI-tract.vtp'
fname_2T = '/Users/odonnell/Dropbox/Coding/OUTPUTS/MICCAI2012/compare_1T_2T/2T-01030-state.vtk'
...
print 'reading'
pd = wma.io.read_polydata(fname_1T)
print 'processing'
pd2 = wma.filter.preprocess(pd,fiber_length, remove_u=False, remove_brainstem=False)
...
print 'reading'
pd = wma.io.read_polydata(fname_2T)
print 'processing'
pd2 = wma.filter.preprocess(pd,fiber_length, remove_u=False, remove_brainstem=False)
print 'random downsampling'
pd2 = wma.filter.downsample(pd2,number_of_fibers)
