...
#indir = '/Users/odonnell/Dropbox/Coding/OUTPUTS/MICCAI2012/test_mouse_reg_feb15/iteration_4'
...
input_median_fas_per_subject = list()
input_pds_downsampled = list()
for pd in input_pds:
    ...
    input_median_fas_per_subject.append(fa_subj)    
...
for fa_subj in input_median_fas_per_subject:
