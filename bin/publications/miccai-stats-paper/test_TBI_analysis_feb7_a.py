...
outdir = '/Users/odonnell/Dropbox/Coding/OUTPUTS/MICCAI2012/test_TBI_reg_feb10'
#outdir = '.'
...
def run_registration(input_poly_datas, outdir, number_of_fibers=150,
    ...
    wma.registration_functions.transform_polydatas_from_disk(input_poly_datas, register, outdir)
...
# registration
run_registration(input_poly_datas, outdir, 
