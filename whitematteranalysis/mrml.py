...
class WriteMRML:
    ...
    def write(self, pd_filenames, colors, filename):
        ...
        #print color_list
        print "writing", len(pd_filenames), "cluster filenames to MRML scene:", filename
        f = open(filename, "w")
        f.write(self.header)
