...
# Why are our plots smoother than in the paper? This re-implementation was not expected to change any of the numbers.
# Was something being truncated before?
...
plt.savefig('objective_function_shear_x_prob.pdf')
...
plt.savefig('objective_function_shear_x_prob_bw.pdf')
...
plt.savefig('objective_function_shear_x_prob_sig_10_30.pdf')
...
plt.savefig('objective_function_shear_x_prob_bw_sig_10_30.pdf')
