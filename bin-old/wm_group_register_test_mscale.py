...
#/Users/odonnell/Dropbox/Coding/OUTPUTS/test_scale_tracts/GAUSSIAN/test_reg_less'
#outdir = '/Users/odonnell/Dropbox/Coding/OUTPUTS/test_scale_tracts/GAUSSIAN/test_reg_less_5s'
#indir = '/Users/odonnell/Dropbox/Coding/OUTPUTS/test_scale_tracts/1pt5mm/all_tracts/smooth_greater_5'
#outdir = '/Users/odonnell/Dropbox/Coding/OUTPUTS/test_scale_tracts/1pt5mm/reg_output_test_1pt5mm'
...
#inputPolyDatas = inputPolyDatas[1:5]

for fname in inputPolyDatas:
    print fname
    pd = wma.io.read_polydata(fname)
    # can't preprocess if fixed-length already!
...
outdir_subdir = os.path.join(outdir, 'output1')
os.mkdir(outdir_subdir)
ren.save_views(outdir_subdir)
del ren
...
output_pds = transform_polydatas(input_pds, register)
ren = view_polydatas(output_pds)
outdir_subdir = os.path.join(outdir, 'output2')
os.mkdir(outdir_subdir)
ren.save_views(outdir_subdir)
del ren
...
output_pds = transform_polydatas(input_pds, register)
ren = view_polydatas(output_pds)
outdir_subdir = os.path.join(outdir, 'output3')
os.mkdir(outdir_subdir)
ren.save_views(outdir_subdir)
del ren

# transform original data
inputDirectory2 = '/Users/lauren/Data/TBI/Tracts/'
inputMask2 = "{0}/*.vtp".format(inputDirectory2)
inputPolyDatas2 = glob.glob(inputMask2)
inputPolyDatas2 = inputPolyDatas2[0:8] + inputPolyDatas2[11:15] + inputPolyDatas2[16:17]
transform_polydatas_from_disk(inputPolyDatas2, register, outdir)
...
output_pds = transform_polydatas(input_pds, register)
ren = view_polydatas(output_pds)
outdir_subdir = os.path.join(outdir, 'output4')
os.mkdir(outdir_subdir)
ren.save_views(outdir_subdir)
del ren
...
output_pds = transform_polydatas(input_pds, register)
ren = view_polydatas(output_pds)
outdir_subdir = os.path.join(outdir, 'outputlast')
os.mkdir(outdir_subdir)
ren.save_views(outdir_subdir)
del ren
